                ...
                {[1, 1, 1, , 1, 1].map((item) => <Grid item container className="shadow-xl rounded-md p-5" sx={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <Grid item xs={6}>
                        <div className="flex items-center space-x-4">
                            <img className="w-[5rem] h-[5rem] object-cover object-top" src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSv2UhYgi4_sLAora2D_T0PXEKlFJVpcAeujC55blqIcj5b0dc43h_gKEzwUdqSy6JYL5dbOKxX1bLGP_jCM_0iZ0cqTwjO1Ujc9beMCl7MSI8wP1ocGg62"
                                alt="" />
